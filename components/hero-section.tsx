      ...
      <div className="container relative px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="text-4xl font-bold tracking-tight text-foreground sm:text-6xl lg:text-7xl text-balance">
            Real graduates shouldn't wait months to{" "}
            <span className="text-primary">prove themselves</span>
          </h1>

          <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-muted-foreground text-pretty">
            Secure, fast, and reliable credential verification platform for
            individuals, employers, and institutions. Eliminate fraud and build
            trust with instant verification.
          </p>
            ...
            <div className="relative rounded-2xl border bg-card p-8 shadow-2xl">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-muted-foreground mt-2">
                    Connected to institutions worldwide
                  </p>
                </div>
              </div>
            </div>
